...
INTO #UDFGridData
from (
select 1 as RowID,	6005 as CaseId,'PW' as LawFirm,'Test Name' as [name],	'9/1/2025' as [date]
UNION SELECT 2,		6005,		'SA',		'Test Test',	'9/9/2025'
UNION SELECT 3,		6005,		'Law Firm',	'John Smith',	'12/9/2024' ) a
