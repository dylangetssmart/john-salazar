...
-- Dynamically get all columns from [JohnSalazar_Needles]..user_tab5_data for unpivoting
...
begin
	insert into [sma_MST_UDFDefinition]
		...
		join [JohnSalazar_Needles].[dbo].[user_tab5_matter] M
			on M.mattercode = mix.matcode
				and M.field_type <> 'label'
		join (select distinct fieldTitle from Other5UDF) vd
