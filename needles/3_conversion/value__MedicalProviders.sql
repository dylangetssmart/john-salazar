...
steps:
	...
	2. Insert Medical Providers		[sma_TRN_Hospitals]
	3. Insert Bills					[sma_TRN_SpDamages]
	4. Update Amount Paid			[sma_TRN_SpecialDamageAmountPaid]
instructions:
	...
	where
		code in (
		 select
			 code
		 from [ValueCodeMap]
		 where [SA_Screen] = 'Medical Providers'
		)
go
...
-- Update hospital TotalBill from Bill section
