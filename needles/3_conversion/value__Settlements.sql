/*---
description: Insert Settlements from [value]
steps:
	1. Setup helper table with relevant id fields
	2. Insert Settlement Types	[sma_MST_SettlementType]
	3. Insert Settlements		[sma_TRN_Settlements]
instructions:
...
exec AddBreadcrumbsToTable 'sma_TRN_Settlements'
go
	...
	where
		code in (
		 select
			 code
		 from [ValueCodeMap]
		 where [SA_Screen] = 'Negotiation/Settlement'
			 and [SA_Field] = 'Settlements'
		);
go
...
--SELECT * FROM [Needles]..value_code vc
