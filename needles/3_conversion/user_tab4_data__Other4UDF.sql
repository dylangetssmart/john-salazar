...
declare @sourceTable SYSNAME = 'user_tab4_data';			-- source data EAV table
declare @targetTable NVARCHAR(25) = 'Other4'			-- target UDF screen				[sma_MST_UDFDefinition].[udfScreenName]
declare @targetTable_grid NVARCHAR(25) = 'UDFs Grid4'	-- target UDF screen (grid)			[sma_MST_UDFDefinition].[udfScreenName]
...
left join [Needles].[dbo].user_tab4_name utn		-- make sure this is correct: i.e. [user_tab2_name] matches with [user_tab2_data]
