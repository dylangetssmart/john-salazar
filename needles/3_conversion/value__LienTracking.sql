/*---
description: Create Lienors from [value]
steps:
	1. Setup helper table with relevant id fields
	2. Insert Lein Types	[sma_MST_LienType]
	3. Insert Lienors		[sma_TRN_Lienors]
	4. Insert Lien Details	[sma_TRN_LienDetails]
instructions:
