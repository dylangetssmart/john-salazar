...
create nonclustered index IX_NonClustered_Index_value_tab_Liencheckbox_Helper_value_id on [JohnSalazar_Needles].[dbo].[value_tab_Liencheckbox_Helper] (value_id);
go
